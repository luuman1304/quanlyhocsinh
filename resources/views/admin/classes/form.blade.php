<div class="form-group row {{ $errors->has('class_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-5 col-sm-5">
        {!! Form::select('class_id', \App\Model\Classes::pluck('class_name', 'id'), null, ['class' => 'form-control simple-dropdown']) !!}
...
<div class="form-group row {{ $errors->has('birthday') ? 'has-error' : ''}}" >
    {!! Form::label('birthday', 'Năm sinh', ['class' => 'col-md-3 col-sm-5 col-form-label']) !!}
    <div class="col-md-9 col-sm-7">
...
<div class="row form-group">
    <div class="col-sm-12 text-right">
        <a href="{{ url('/home/classes-list') }}" class="btn btn-default">Huỷ Bỏ</a>
